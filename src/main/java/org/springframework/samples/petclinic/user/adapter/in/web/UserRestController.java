...
package org.springframework.samples.petclinic.user.adapter.in.web;
...
/**
 * Input adapter (REST controller) for user operations.
...
public class UserRestController implements UsersApi {
    ...
    public UserRestController(UserUseCase useCase) {
    ...
    public ResponseEntity<UserDto> addUser(UserDto userDto) {
        ...
        UserDto result = useCase.addUser(userDto);
